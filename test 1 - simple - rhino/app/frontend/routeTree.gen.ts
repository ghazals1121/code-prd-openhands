...
import { Route as AuthenticatedOwnerAppointmentImport } from './routes/_authenticated/$owner/appointment';
import { Route as AuthenticatedOwnerAppointmentIndexImport } from './routes/_authenticated/$owner/appointment/index';
import { Route as AuthenticatedOwnerAppointmentFormImport } from './routes/_authenticated/$owner/appointment/form';
import { Route as AuthenticatedOwnerAppointmentConfirmationImport } from './routes/_authenticated/$owner/appointment/confirmation';
...
const AuthenticatedOwnerAppointmentRoute =
  AuthenticatedOwnerAppointmentImport.update({
    id: '/appointment',
    path: '/appointment',
    getParentRoute: () => AuthenticatedOwnerRoute
  } as any);

const AuthenticatedOwnerAppointmentIndexRoute =
  AuthenticatedOwnerAppointmentIndexImport.update({
    id: '/',
    path: '/',
    getParentRoute: () => AuthenticatedOwnerAppointmentRoute
  } as any);

const AuthenticatedOwnerAppointmentFormRoute =
  AuthenticatedOwnerAppointmentFormImport.update({
    id: '/form',
    path: '/form',
    getParentRoute: () => AuthenticatedOwnerAppointmentRoute
  } as any);

const AuthenticatedOwnerAppointmentConfirmationRoute =
  AuthenticatedOwnerAppointmentConfirmationImport.update({
    id: '/confirmation',
    path: '/confirmation',
    getParentRoute: () => AuthenticatedOwnerAppointmentRoute
  } as any);
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_authenticated/$owner/appointment': {
      id: '/_authenticated/$owner/appointment';
      path: '/appointment';
      fullPath: '/$owner/appointment';
      preLoaderRoute: typeof AuthenticatedOwnerAppointmentImport;
      parentRoute: typeof AuthenticatedOwnerImport;
    };
    '/_authenticated/$owner/appointment/': {
      id: '/_authenticated/$owner/appointment/';
      path: '/';
      fullPath: '/$owner/appointment/';
      preLoaderRoute: typeof AuthenticatedOwnerAppointmentIndexImport;
      parentRoute: typeof AuthenticatedOwnerAppointmentImport;
    };
    '/_authenticated/$owner/appointment/form': {
      id: '/_authenticated/$owner/appointment/form';
      path: '/form';
      fullPath: '/$owner/appointment/form';
      preLoaderRoute: typeof AuthenticatedOwnerAppointmentFormImport;
      parentRoute: typeof AuthenticatedOwnerAppointmentImport;
    };
    '/_authenticated/$owner/appointment/confirmation': {
      id: '/_authenticated/$owner/appointment/confirmation';
      path: '/confirmation';
      fullPath: '/$owner/appointment/confirmation';
      preLoaderRoute: typeof AuthenticatedOwnerAppointmentConfirmationImport;
      parentRoute: typeof AuthenticatedOwnerAppointmentImport;
    };
...
interface AuthenticatedOwnerAppointmentRouteChildren {
  AuthenticatedOwnerAppointmentIndexRoute: typeof AuthenticatedOwnerAppointmentIndexRoute;
  AuthenticatedOwnerAppointmentFormRoute: typeof AuthenticatedOwnerAppointmentFormRoute;
  AuthenticatedOwnerAppointmentConfirmationRoute: typeof AuthenticatedOwnerAppointmentConfirmationRoute;
}

const AuthenticatedOwnerAppointmentRouteChildren: AuthenticatedOwnerAppointmentRouteChildren =
  {
    AuthenticatedOwnerAppointmentIndexRoute:
      AuthenticatedOwnerAppointmentIndexRoute,
    AuthenticatedOwnerAppointmentFormRoute:
      AuthenticatedOwnerAppointmentFormRoute,
    AuthenticatedOwnerAppointmentConfirmationRoute:
      AuthenticatedOwnerAppointmentConfirmationRoute
  };

const AuthenticatedOwnerAppointmentRouteWithChildren =
  AuthenticatedOwnerAppointmentRoute._addFileChildren(
    AuthenticatedOwnerAppointmentRouteChildren
  );
...
interface AuthenticatedOwnerRouteChildren {
  ...
  AuthenticatedOwnerAppointmentRoute: typeof AuthenticatedOwnerAppointmentRouteWithChildren;
}
...
const AuthenticatedOwnerRouteChildren: AuthenticatedOwnerRouteChildren = {
  ...
  AuthenticatedOwnerAppointmentRoute:
    AuthenticatedOwnerAppointmentRouteWithChildren
};
...
export interface FileRoutesByFullPath {
  ...
  '/$owner/appointment': typeof AuthenticatedOwnerAppointmentRouteWithChildren;
  '/$owner/appointment/form': typeof AuthenticatedOwnerAppointmentFormRoute;
  '/$owner/appointment/confirmation': typeof AuthenticatedOwnerAppointmentConfirmationRoute;
  '/$owner/appointment/': typeof AuthenticatedOwnerAppointmentIndexRoute;
...
export interface FileRoutesById {
  ...
  '/_authenticated/$owner/appointment': typeof AuthenticatedOwnerAppointmentRouteWithChildren;
  '/_authenticated/$owner/appointment/form': typeof AuthenticatedOwnerAppointmentFormRoute;
  '/_authenticated/$owner/appointment/confirmation': typeof AuthenticatedOwnerAppointmentConfirmationRoute;
  '/_authenticated/$owner/appointment/': typeof AuthenticatedOwnerAppointmentIndexRoute;
...
export interface FileRouteTypes {
  ...
  fullPaths:
    ...
    | '/$owner/'
    | '/$owner/appointment'
    | '/$owner/appointment/form'
    | '/$owner/appointment/confirmation'
    | '/$owner/appointment/'
    | '/$owner/$model/new'
...
/* ROUTE_MANIFEST_START
{
  "routes": {
    ...
    "/_authenticated/$owner/appointment": {
      "filePath": "_authenticated/$owner/appointment.tsx",
      "parent": "/_authenticated/$owner",
      "children": [
        "/_authenticated/$owner/appointment/form",
        "/_authenticated/$owner/appointment/confirmation",
    ...
    "/_authenticated/$owner/appointment/": {
      "filePath": "_authenticated/$owner/appointment/index.tsx",
      "parent": "/_authenticated/$owner/appointment"
    },
    "/_authenticated/$owner/appointment/form": {
      "filePath": "_authenticated/$owner/appointment/form.tsx",
      "parent": "/_authenticated/$owner/appointment"
    },
    "/_authenticated/$owner/appointment/confirmation": {
      "filePath": "_authenticated/$owner/appointment/confirmation.tsx",
      "parent": "/_authenticated/$owner/appointment"
    }
  }
}
